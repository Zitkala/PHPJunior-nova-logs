...
<ul class="list-reset mb-8">
    <li class="leading-wide mb-4 text-sm">
        <router-link :to="{name: 'nova-log-viewer2-dashboard'}" class="text-white ml-8 no-underline dim">
            Dashboard
        </router-link>
    </li>
    <li class="leading-wide mb-4 text-sm">
        <router-link :to="{name: 'nova-log-viewer2-list'}" class="text-white ml-8 no-underline dim">
            Logs
        </router-link>
    </li>
</ul>
